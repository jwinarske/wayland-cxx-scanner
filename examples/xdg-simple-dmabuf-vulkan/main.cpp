...
// renders a coloured triangle (red/green/blue vertices) via a Vulkan graphics
...
//
//   // Vertex shader (location 0 = vec2 pos, location 1 = vec3 color)
//   #version 450
...
static constexpr uint32_t kVertSpv[] = {
    0x07230203u, 0x00010000u, 0x0008000bu, 0x00000021u, 0x00000000u, 0x00020011u, 0x00000001u, 0x0006000bu,
    0x00000001u, 0x4c534c47u, 0x6474732eu, 0x3035342eu, 0x00000000u, 0x0003000eu, 0x00000000u, 0x00000001u,
    0x0009000fu, 0x00000000u, 0x00000004u, 0x6e69616du, 0x00000000u, 0x0000000du, 0x00000012u, 0x0000001du,
    ...
    0x0065636eu, 0x00030005u, 0x0000000du, 0x00000000u, 0x00040005u, 0x00000012u, 0x705f6e69u, 0x0000736fu,
    0x00050005u, 0x0000001du, 0x67617266u, 0x6c6f635fu, 0x0000726fu, 0x00050005u, 0x0000001fu, 0x635f6e69u,
    0x726f6c6fu, 0x00000000u, 0x00030047u, 0x0000000bu, 0x00000002u, 0x00050048u, 0x0000000bu, 0x00000000u,
    ...
    0x00000004u, 0x00040047u, 0x00000012u, 0x0000001eu, 0x00000000u, 0x00040047u, 0x0000001du, 0x0000001eu,
    0x00000000u, 0x00040047u, 0x0000001fu, 0x0000001eu, 0x00000001u, 0x00020013u, 0x00000002u, 0x00030021u,
    ...
    0x00000019u, 0x00000003u, 0x00000007u, 0x00040017u, 0x0000001bu, 0x00000006u, 0x00000003u, 0x00040020u,
    0x0000001cu, 0x00000003u, 0x0000001bu, 0x0004003bu, 0x0000001cu, 0x0000001du, 0x00000003u, 0x00040020u,
    0x0000001eu, 0x00000001u, 0x0000001bu, 0x0004003bu, 0x0000001eu, 0x0000001fu, 0x00000001u, 0x00050036u,
    ...
    0x0000001du, 0x00000020u, 0x000100fdu, 0x00010038u,
};
...
bool App::InitVulkan() {
  ...
  // just whether the compositor honours the alpha channel).
  ...
  {
    auto pl_rv = vk_.device->createPipelineLayoutUnique({});
...
void App::RenderFrame() noexcept {
  ...
  // Clear to black, then draw the red/green/blue triangle.
...
int main(int argc, char** argv) {
  ...
  static constexpr option kLongOpts[] = {
      ...
      {"height",     required_argument, nullptr, 'e'},
